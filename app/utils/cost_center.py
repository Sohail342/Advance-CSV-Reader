...
REQUIRED_HEADERS = ["BranchCode", "CostCenterID", "CostCenterName", "Region", "BranchName", "CostCenterDescription"]

async def create_cost_center(db: AsyncSession, data: UploadFile):
    ...
    # Create ORM objects
    objs = [CostCenter(**rec) for rec in records]
